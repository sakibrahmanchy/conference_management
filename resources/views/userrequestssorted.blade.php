...
<ul class="nav nav-pills col-md-offset-3" role="tablist">
  ...
  <li role="presentation" class = "active"><a href="{{route('allotments')}}">Allotment Requests</a></li>
...
<div class="container">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner jumbotron" role="listbox" style = "background-color:#204d74 ;color: #f5f5f5;">
       <center><h2> Requests for {{$housename}} </h2></center>
        @foreach($userRequests as $index=>$userRequest)
                <div class="item @if($index==0) {{ 'active' }} @endif">
                        ...
                        <div class="col-sm-4" style = "text-align: left; background-color:#204d74 ">
                            <p></p><br><br><br>
                             ...
                             <p><b>Points:</b>  {{$userRequest->point}}</p>
                        ...
                        <div class="col-sm-4" style = "text-align: left; background-color:#204d74 ">
                            <p></p><br><br><br><br>
                             ...
                             <a href="{{route('allotment.accept',['userid'=>$userRequest->userID,'houseName'=>$userRequest->houseName])}}" type = "button" class = "btn btn-primary">Accept</a>
                            <a href="{{route('allotment.reject',['userid'=>$userRequest->userID,'houseName'=>$userRequest->houseName])}}" type = "button" class = "btn btn-primary">Reject</a><br><br>
                        </div>
