...
<ul class="nav nav-pills col-md-offset-3" role="tablist">
  <li role="presentation" ><a href="{{route('user.requests')}}">User Requests <span class="badge"></span></a></li>
  <li role="presentation" class = "active"><a href="{{route('all_conferences')}}">Conferences <span class="badge"></span></a></li>
</ul><br>
